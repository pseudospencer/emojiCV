...
function draw() {
    ...
    if (positions.length > 0) {
        // stroke(0);
        // fill(255);
        // drawFaceComponentShape(lEye);
        // drawFaceComponentShape(rEye);
        drawFaceComponentEmoji(lEye, "👁");
        drawFaceComponentEmoji(rEye, "👁");

        // fill(0, 255, 0);
        // drawFaceComponentShape(rEyebrow);
        // drawFaceComponentShape(lEyebrow);
        drawFaceComponentEmoji(rEyebrow, "🧤");
        drawFaceComponentEmoji(lEyebrow, "🌸");

        // fill(255, 0, 0);
        // drawFaceComponentShape(uLip);
        // drawFaceComponentShape(bLip);
...
function drawFaceComponentShape(componentPoints) {
    // Not for pupils
    beginShape();
